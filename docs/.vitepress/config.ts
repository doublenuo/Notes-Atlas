...
export default defineConfig({
  ...
  themeConfig: {
    ...
    sidebar: {
      '/meet/': [
        {
          text: '组会论文',
          collapsed: true,
          items: getSidebarItems('meet/docs')
        },
        {
          text: "其他论文",
          items: getSidebarItems('meet/self')
        }
      ],
      "/study/": [
        {
          text: '深度学习 (DL)',
          collapsed: true,
          items: getSidebarItems('study/dl/docs')
        },
        {
          text: '强化学习 (RL)',
          collapsed: true,
          items: getSidebarItems('study/rl/docs')
        },
        {
          text: 'ROS',
          collapsed: true,
          items: getSidebarItems('study/ros/docs')
        },
        {
          text: '具身智能',
          collapsed: true,
          items: getSidebarItems('study/embody-ai')
        }
      ],
      "/tools/": [
        {
          text: '必备工具',
          items: getSidebarItems('tools/resources/docs')
        },
        {
          text: 'Linux',
          items: getSidebarItems('tools/linux/docs')
        },

        {
          text: '面试题',
          items: getSidebarItems('tools/interview/docs')
        }
      ],
      "/archive/": [
        {
          text: '归档资源',
          items: getSidebarItems('archive/docs')
        }
      ]
      ...
      //       { text: 'GMR', link: '/meet/self/GMR.md' },
      //     ]
      //   }
      // ],
